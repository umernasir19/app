package com.example.hafizumerbinnasir.Debiatologist;
...
public class Diabetologist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diabetologist);



            listView = (ListView) findViewById(R.id.diaboalist);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (position == 0) {
                        ...
                        Intent myintent = new Intent(view.getContext(), Dr_Asma_Maqsood.class);
                        startActivity(myintent);
